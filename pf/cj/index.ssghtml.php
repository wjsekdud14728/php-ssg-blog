...
<div id="content">
  ...
  <!-- 섹션 1 -->
  <section class="section-1" data-one-page-link="page1" data-one-page-menu-target-diff-y="-70%">
  ...
  <!-- 섹션 2 -->
  <section class="section-2 relative flex" data-one-page-link="page2" data-one-page-menu-target-diff-y="-50%">
    <div class="section-2__bg-image">
      <div class="section-2__title-box">
        <div class="title"><span>Business</span><span>Introduction</span></div>
        <nav class="list">
          <ul>
            <li class="active"><span>디지털</span><span>비즈니스</span></li>
            <li><span>솔루션</span><span>비즈니스</span></li>
            <li><span>서비스형</span><span>비즈니스</span></li>
            <li><span>시스템형</span><span>비즈니스</span></li>
          </ul>
        </nav>
      </div>
    </div>
  ...
  <section class="section-3" data-one-page-link="page3" data-one-page-menu-target-diff-y="-500px">
      ...
      <div class="section-3__main-article-box">
        <a href="#">
          <div class="thumb img-box">
            <img src="https://cdn.jsdelivr.net/gh/wjsekdud14728/web-res/cj/section-3__main-article-img.jpg" alt="">
            <div class="box"></div>
          </div>
          <div class="txt">
