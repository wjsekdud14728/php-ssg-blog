                    ...
                    <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
                        ...
                        <g id="Clothing/Shirt-Crew-Neck" transform="translate(0.000000, 170.000000)">
                            <defs>
                                <path
                                    ...
                                    id="react-path-224"></path>
                            </defs>
                            <mask id="react-mask-225" fill="white">
                                <use xlink:href="#react-path-224"></use>
                            </mask>
                            <use id="Clothes" fill="#E6E6E6" fill-rule="evenodd" xlink:href="#react-path-224"></use>
                            <g id="Color/Palette/Gray-01" mask="url(#react-mask-225)" fill-rule="evenodd"
                                fill="#262E33">
                                <rect id="🖍Color" x="0" y="0" width="264" height="110"></rect>
                            </g>
                            <g id="Shadowy" opacity="0.599999964" stroke-width="1" fill-rule="evenodd"
                                mask="url(#react-mask-225)" fill-opacity="0.16" fill="#000000">
                        ...
                        <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
                            <g id="Mouth/Eating" transform="translate(2.000000, 52.000000)">
                                <g id="Om-Nom-Nom" opacity="0.599999964" stroke-width="1"
                                    transform="translate(28.000000, 6.000000)" fill-opacity="0.599999964"
                                    fill="#000000">
                                    <path
                            ...
                            <g id="Eyebrow/Outline/Up-Down" fill-opacity="0.599999964" fill-rule="nonzero">
                                <path
                        ...
                        <g id="Top" stroke-width="1" fill-rule="evenodd">
                            <defs>
                                <rect id="react-path-902" x="0" y="0" width="264" height="280"></rect>
                                <path
                                ...
                                <path
                                    ...
                                    id="react-path-904"></path>
                            </defs>
                            <mask id="react-mask-900" fill="white">
                                <use xlink:href="#react-path-902"></use>
                            </mask>
                            <g id="Mask"></g>
                            <g id="Top/Long-Hair/Straight" mask="url(#react-mask-900)">
                                <g transform="translate(-1.000000, 0.000000)">
                                    <g id="Hair" stroke-width="1" fill="none" fill-rule="evenodd"
                                        transform="translate(40.000000, 15.000000)">
                                        <mask id="react-mask-901" fill="white">
                                            <use xlink:href="#react-path-903"></use>
                                        </mask>
                                        <use fill="#272C2E" xlink:href="#react-path-903"></use>
                                        <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-901)" fill="#4A312C">
